...
var model = [{
  type: "title",
  value: "JavaScript Sites Constructor",
  options: {
    styles: {
      padding: "1.5rem",
...
function css(obj) {
  var styles = obj.options.styles;
  var keys = Object.keys(styles);
  var result = keys.map(function (style) {
    return "".concat(style, ": ").concat(styles[style]);
  }).join(';');
...
function title(obj) {
  var styles = (0, _utils.css)(obj);
  console.log(styles);
  return (0, _utils.row)((0, _utils.col)("<h1>".concat(obj.value, "</h1>"), styles));
}

function text(obj) {
  return (0, _utils.row)((0, _utils.col)("<p>".concat(obj.value, "</p>")));
}

function columns(obj) {
  var html = '';
  obj.value.map(function (item) {
    html += (0, _utils.col)("<p>".concat(item, "</p>"));
  });
  return (0, _utils.row)(html);
}

function image(obj) {
  return (0, _utils.row)("<img src=\"".concat(obj.value, "\" alt=\"\">"));
}
